...
CreateConVar("sv_wdrk_max_tx_power", 1000.0,FCVAR_ARCHIVE ) -- Maximum transmit power in Watts
CreateConVar("sv_wdrk_rx_sensitivity_threshold", -90.0,FCVAR_ARCHIVE ) -- Receive sensitivity in dbm
